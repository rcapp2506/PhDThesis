...
2026-05-07  R. Cappuccio / Claude  (Wave E -- Signorelli S6/S7 global-style sweep)
  ...
  (Sec.~\ref{sec:notation} in introduction_revised.tex):
    * The block was previously enclosed in a
      \begin{comment}...\end{comment} fence. Fence removed.
...
the two primary coherence times are $T_1$ (energy relaxation, the time scale for $\ket{1}\to\ket{0}$ decay) and $T_2$ (dephasing, the time scale for loss of phase coherence).
