...
% PLACEHOLDER — Wave I Step 2.C will migrate here:
%   §2 lines 1332--1424 (energy levels, dispersive shifts, ZZ coupling, performance summary).
% + §3 lines 1426--1450 (Baseline Validation, merged as closing paragraph).
% Action: KEEP+MERGE. The current standalone §3 will be emptied in Step 2.D.
% =============================================================================
